package com.dc.ybjoRabbitMQ.controller;

import com.dc.ybjoRabbitMQ.entity.LogEntity;
import com.dc.ybjoRabbitMQ.entity.UserEntity;
import com.dc.ybjoRabbitMQ.rabbimtMq.RabbitMQSender;
import com.dc.ybjoRabbitMQ.service.LogService;
...
public class BusinessController {
    ...
    public String updateUserEntity(UserEntity userEntity) throws InterruptedException {
        //开始时间
        ...
        LOGGER.info("异步执行共花费{}豪秒", System.currentTimeMillis() - startTime);
