...
import com.dc.ybjoRabbitMQ.service.ProductService;
...
public class RabbingListener {

    @Autowired
    private ProductService productService;

    private static final Logger LOGGER = LoggerFactory.getLogger(RabbingListener.class);
